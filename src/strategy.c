...
Strategy_Result *strategy(Candle *candles) {
    ...
    //         }
    //         if (can_op) {
    //             float daily_high_up_to_current_candle = get_daily_high_up_to_current_candle(candles, i);
    //             float daily_low_up_to_current_candle = get_daily_low_up_to_current_candle(candles, i);
    //
    //             // if (fabs(entry_price - daily_high_up_to_current_candle) > 10.0) {
    //             //     continue;
    //             // }
    //             // if (fabs(daily_low_up_to_current_candle - entry_price) < 10.0) {
    //             //     continue;
    //             // }
    //
    //             take_profit = entry_price - 10;
    //             stop_loss = get_high(candles, i - 1) + 0.5;
    //
    ...
    //             strategy_result[strategy_result_count].take_profit_pts = entry_price - take_profit;
    //             strategy_result[strategy_result_count].stop_loss = stop_loss;
    //             strategy_result[strategy_result_count].stop_loss_pts = stop_loss - entry_price;
...
void __print_strategy_result(Strategy_Result *strategy_result) {
    ...
    //     printf("%.1f\t", strategy_result[i].take_profit_pts);
    //     printf("%.1f\t", strategy_result[i].stop_loss);
    //     printf("%.1f\t", strategy_result[i].stop_loss_pts);
